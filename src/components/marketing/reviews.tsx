        ...
        <div className="flex flex-col items-center justify-center py-12 md:py-16 lg:py-24  w-full">
            <Container>
                <div className="flex flex-col items-center text-center max-w-xl mx-auto">
                    <SectionBadge title={t("nuestrosClientes", language)} />
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        {t("dicenClientes", language)}
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                       {t("generamosResultados", language)}
                    </p>
                </div>
            </Container>
            <Container>
    ...
    return (
        <figure className="relative w-64 cursor-pointer overflow-hidden rounded-xl border border-foreground/5 bg-neutral-50/[.05] hover:bg-foreground/10 p-4 transition-all duration-300 ease-in-out">
            <div className="flex flex-row items-center gap-2">
                <SmartImage className="rounded-full" width={32} height={32} sizes="32px" loading="lazy" alt="" src={img} />
