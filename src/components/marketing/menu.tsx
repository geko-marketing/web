...
const Menu = () => {
    ...
    return (
        <NavigationMenu>
            <NavigationMenuList className="justify-center w-full gap-4">
                <NavigationMenuItem>
                    <NavigationMenuLink asChild className="h-10 px-4 py-2 text-sm font-normal rounded-md text-muted-foreground hover:text-foreground w-max hover:bg-none text-center">
                        <Link href="/">
                            {t("inicio", language)}
                        </Link>
                    </NavigationMenuLink>
                ...
                <NavigationMenuItem>
                    <NavigationMenuTrigger className="text-muted-foreground hover:text-foreground text-center">
                                ...
                                <NavigationMenuLink asChild>
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            {t("paquetesDesc", language)}
                                        </p>
                                    </Link>
                                </NavigationMenuLink>
                            </li>
                            <Item title={t("gestionRedesSociales", language)} href="/services" icon={<HashIcon className="w-5 h-5" />}>
                                {t("gestionRedesSocialesDesc", language)}
                            </Item>
                            <Item title={t("impulsoMarca", language)} href="/services" icon={<CalendarRangeIcon className="w-5 h-5" />}>
                                {t("impulsoMarcaDesc", language)}
                            </Item>
                            <Item title={t("creacionPaginasWeb", language)} href="/services" icon={<UsersIcon className="w-5 h-5" />}>
                                {t("creacionPaginasWebDesc", language)}
                            </Item>
                        </ul>
                    </NavigationMenuContent>
                </NavigationMenuItem>
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <ul className="grid w-[400px] gap-3 p-4 md:w-[400px] md:grid-cols-2 lg:w-[500px] xl:w-[500px]">
                            <Item title={t("acercaDe", language)} href="/" icon={<Newspaper className="w-5 h-5" />}>
                                {t("acercaDeDesc", language)}
                            </Item>
                            <Item title={t("contacto", language)} href="/" icon={<CircleHelp className="w-5 h-5" />}>
                                {t("contactoDesc", language)}
                            </Item>
                        </ul>
                    </NavigationMenuContent>
                </NavigationMenuItem>
